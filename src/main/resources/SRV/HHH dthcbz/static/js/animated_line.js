...
ymaps.modules.define('AnimatedLine', ['util.defineClass', 'Polyline', 'vow'], function(
	provide,
	defineClass,
	Polyline,
	vow
	...
	function AnimatedLine(geometry, properties, options) {
		...
		this._loopTime = 50
		this._animationTime = this.options.get('animationTime', 4000) // Вычислим длину переданной линии.
		...
		this._animationInterval = (distance / this._animationTime) * this._loopTime // Создадим массив с более частым расположением промежуточных точек.
	...
	defineClass(AnimatedLine, Polyline, {
		...
		start: function start() {
			...
			var line = this
			var loopTime = this._loopTime // Будем добавлять по одной точке каждые 50 мс.
...
//# sourceMappingURL=animated_line.js.map
