...
!(function(e, t) {
	...
	'object' == (typeof module === 'undefined' ? 'undefined' : _typeof(module)) && 'object' == _typeof(module.exports)
									...
									var n = this,
										...
										e = function e() {
											...
											if (!(i < u)) {
												...
												;(t =
													e && ('object' == _typeof(e) || 'function' == typeof e) && e.then),
													m(t)
														? s
	...
	k.extend({
		...
		style: function style(e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				...
				'string' === (o = _typeof(n)) && (i = ne.exec(n)) && i[1] && ((n = le(e, t, i)), (o = 'number')),
					null != n &&
						n == n &&
		...
		trigger: function trigger(e, t, n, r) {
			...
			if (
				...
				3 !== n.nodeType &&
					...
					(u = d.indexOf(':') < 0 && 'on' + d),
					((e = e[k.expando] ? e : new k.Event(d, 'object' == _typeof(e) && e)).isTrigger = r ? 2 : 3),
					(e.namespace = h.join('.')),
				...
				return {
					send: function send(e, t) {
						...
						;(_o = function o(e) {
							return function() {
								_o &&
									((_o = a = r.onload = r.onerror = r.onabort = r.ontimeout = r.onreadystatechange = null),
									'abort' === e
										? r.abort()
										: 'error' === e
	...
	k.ajaxSetup({
		...
		(k.fn.load = function(e, t, n) {
			...
			return (
				...
				m(t) ? ((n = t), (t = void 0)) : t && 'object' == _typeof(t) && (i = 'POST'),
				0 < a.length &&
					k
						.ajax({
							url: e,
